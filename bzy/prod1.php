...
<section id="ps-container" class="ps-container">
	...
	<div class="ps-contentwrapper">
		<div id="prod1" class="ps-content">
			...
			<p>Беспроводное зарядное устройство имеет широкую зарядную область с 3-мя катушками, что позволяет заряжать девайсы еще быстрее.
				Легко используется на ходу.</p>
